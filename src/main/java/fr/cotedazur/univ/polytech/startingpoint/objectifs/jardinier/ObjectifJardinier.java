package fr.cotedazur.univ.polytech.startingpoint.objectifs.jardinier;
...
import fr.cotedazur.univ.polytech.startingpoint.elements.amenagements.Enclos;
import fr.cotedazur.univ.polytech.startingpoint.elements.amenagements.Engrais;
...
public class ObjectifJardinier extends Objectif {
    ...
    private final AmenagmentAttribuable arrangementRequis;
    ...
    public ObjectifJardinier(Couleur couleur, int tailleRequise, int points, AmenagmentAttribuable arrangement, int nombreRequis) {
    ...
    public ObjectifJardinier(Couleur couleur, int tailleRequise, int points) {
        this(couleur, tailleRequise, points, AmenagmentAttribuable.AUCUN, 1);
    }
    ...
    private boolean verifierAmenagement(Parcelle p) {
        ...
        if (this.arrangementRequis == AmenagmentAttribuable.AUCUN) {
            return true;
        }
    ...
    public String toString() {
        String amenagementTxt = (arrangementRequis != AmenagmentAttribuable.AUCUN) ? " avec " + arrangementRequis : "";
        return "Objectif Jardinier : Bambou " + couleur + " de taille " + tailleRequise + amenagementTxt + " (" + getPoints() + "pts)";
    }

    public AmenagmentAttribuable getArrangementRequis() {
