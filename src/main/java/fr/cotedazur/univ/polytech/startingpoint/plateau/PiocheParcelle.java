...
import fr.cotedazur.univ.polytech.startingpoint.plateau.CarteParcelle;
...
public class PiocheParcelle {
    ...
    public void remplirPioche() {
        for (CarteParcelle definition : CarteParcelle.values()) {
    ...
    public Parcelle piocher() {
        ...
        return piocheDeParcelle.remove(0);
    }
