...
import static fr.cotedazur.univ.polytech.startingpoint.elements.reserve.AmenagmentAttribuable.*;
...
public enum CarteBambou {
    ...
    int taille;
    int nombreDeBambous;
    AmenagmentAttribuable arrangement;
    int points;

    CarteBambou(Couleur couleur, int nombreDeBambous, int taille, AmenagmentAttribuable arrangement, int points) {
    ...
    public AmenagmentAttribuable getArrangement() { return (AmenagmentAttribuable) arrangement; } // Cast nécessaire si tu as laissé "Object"
