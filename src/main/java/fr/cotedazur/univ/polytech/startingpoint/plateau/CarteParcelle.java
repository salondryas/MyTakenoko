...
import fr.cotedazur.univ.polytech.startingpoint.plateau.amenagements.*;
...
public enum CarteParcelle {
    ...
    CarteParcelle(Couleur couleur, int nombreExemplaires, Function<Parcelle, Amenagement> generateurAmenagement) {
